...
# Evidencia: Indicar qué salida o registro demuestra el resultado.
# Responsable: Área o rol responsable, evitando datos personales innecesarios.
...
main() {
  ...
  if [[ "$DRY_RUN" == true ]]; then
    log "Modo de simulación activo. No se aplicarán cambios."
  fi
